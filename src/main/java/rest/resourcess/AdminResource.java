...
import static rest.constants.AdminResourceConstants.ADD_ADMIN_STATUS;
import static rest.constants.AdminResourceConstants.ADMIN_NOT_ADDED;
import static rest.constants.AdminResourceConstants.ADMIN_SUCCESSFULLY_ADDED;
...
public class AdminResource {
    ...
    public Response addNewAdmin(UserImpl iob_user) {
        ...
        try {
            ...
            if (!lva_adminAdded) {
                lob_returnMessage.put(ADD_ADMIN_STATUS, ADMIN_NOT_ADDED);
            ...
            lob_returnMessage.put(ADD_ADMIN_STATUS, ADMIN_SUCCESSFULLY_ADDED);
            return Response.ok()
                    .entity(lob_returnMessage.toJSONString())
                    .build();

        } catch (UserEmptyException ex) {
            lob_returnMessage.put(ADD_ADMIN_STATUS, ex.getMessage());
